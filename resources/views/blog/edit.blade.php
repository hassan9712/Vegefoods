          ...
          <div class="card">
            ...
            <form action="{{ route('dashboard.blogs.update', $blog->id) }}" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <textarea type="text" class="form-control" id="description" name="description" autocomplete="off" value="{{ $blog->description }}"></textarea>
                ...
                <div class="form-footer">
                    <button type="submit" class="btn btn-success"><i class="fa fa-check-square-o"></i> Edit Blog</button>
                </div>
              </form>
            </div>
          </div>
