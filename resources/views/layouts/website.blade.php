...
<html lang="en">
  ...
  <body class="goto-here">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="{{ route('/') }}">Vegefoods</a>
      ...
      <div class="container">
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4 ml-md-5">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href="{{ route('contact-us') }}" class="py-2 d-block">Contact Us</a></li>
              </ul>
            </div>
          </div>
          <div class="col-md-4">
             <div class="ftco-footer-widget mb-4">
              ...
              <div class="d-flex">
	              ...
	              <ul class="list-unstyled">
	                ...
	                <li><a href="{{ route('contact-us') }}" class="py-2 d-block">Contact</a></li>
	              </ul>
	            </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p>
						  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart color-danger" aria-hidden="true"></i> by Hassan Salah
